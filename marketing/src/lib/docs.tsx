...
/**
 * Public help-center content for thinkaisolutions.com/help. Ported from the in-console help
 * docs; icons are dropped (the marketing site has no icon dependency) and app-only links point
 * at the console. Categories + articles are static data so the site stays backend-free.
 */
...
export const DOC_CATEGORIES: DocCategory[] = [
  { id: 'getting-started', title: 'Getting Started', description: 'Set up your workspace and learn the basics.' },
  { id: 'whatsapp', title: 'WhatsApp Setup', description: 'Connect your WABA via Meta Embedded Signup.' },
  { id: 'templates', title: 'Templates', description: 'Create, submit, and manage message templates.' },
  { id: 'campaigns', title: 'Campaigns', description: 'Build, schedule, and measure broadcasts.' },
  { id: 'contacts', title: 'Contacts', description: 'Import audiences, segments, and tags.' },
  { id: 'analytics', title: 'Analytics', description: 'Delivery rates and reporting.' },
  { id: 'developers', title: 'Developers', description: 'API keys, webhooks, and SDKs.' },
  { id: 'billing', title: 'Billing', description: 'Plans, pricing, and invoices.' },
  { id: 'troubleshooting', title: 'Troubleshooting', description: 'Fix connection, sync, and Meta errors.' },
];
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ol>
          <li>Confirm your name and contact details under <a href={`${CONSOLE_URL}/account`}>Your Account</a>.</li>
    ...
    body: (
      <>
        ...
        <ol>
          ...
          <li>Embedded Signup registers the number for sending automatically.</li>
        </ol>
        <p>
    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li>Re-run Embedded Signup to re-link the number if needed.</li>
